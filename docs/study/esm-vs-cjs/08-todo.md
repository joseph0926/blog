...
- [x] 정적 분석 → 사용하지 않는 export 탐지 → dead code elimination 과정 → [13-tree-shaking-qna.md](./13-tree-shaking-qna.md)
- [x] `import { a } from 'lib'`에서 `b`를 안 쓰면 번들러가 제거하는 흐름 → [13-tree-shaking-qna.md](./13-tree-shaking-qna.md)
- [x] **side effects**: `"sideEffects": false` 설정의 의미 → [13-tree-shaking-qna.md](./13-tree-shaking-qna.md)
- [x] barrel file(`index.ts`)이 tree-shaking을 방해하는 이유 → [13-tree-shaking-qna.md](./13-tree-shaking-qna.md)
...
| 3    | Tree-shaking 동작 원리              | 번들러 글에서 예고한 주제             | ✅ 완료 ([13번](./13-tree-shaking-qna.md))                  |
...
_작성일: 2026-02-03_
_업데이트: 2026-02-09 (추가 대화 반영: 3순위 Tree-shaking 문서화 완료 체크)_
