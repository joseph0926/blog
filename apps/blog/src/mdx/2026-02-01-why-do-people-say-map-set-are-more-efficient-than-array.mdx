...
위 예시처럼 `indexOf`를 사용하여 특정 값을 "검색"할 때 많은 책,글에서 "그럴때는 Map or Set을 이용하여 최적화해라~" 라고 합니다.
...
<table>
  ...
  <tbody>
    <tr>
      <td>값 검색/존재 확인/삭제가 빈번</td>
      <td>Map / Set</td>
    </tr>
    <tr>
      <td>데이터가 매우 적음 (수십 개 이하)</td>
      <td>Array</td>
    </tr>
    <tr>
      <td>전체 순회가 주 작업</td>
