...
description: '‘First visit quickly’ → ‘Let’s focus only on repeat visits’ → ‘Prepaint later’. We share practical concerns about open source planning learned through target redefinition, complexity compromise, and architecture conversion.'
date: '2025-10-11'
