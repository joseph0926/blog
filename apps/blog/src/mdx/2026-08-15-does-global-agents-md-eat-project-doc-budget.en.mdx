...
I had understood the limit to cover the global and project files together. A third-party [configuration guide](https://thepromptshelf.dev/blog/agents-md-codex-setup-guide-2026/) made the same interpretation and advised shrinking the global file: "Every byte in `~/.codex/AGENTS.md` is a byte that cannot be used by project-level files." It also recommended keeping the global file below 2 to 3 KB.
