...
description: 'How we fixed a useQueries combine bug with StoragePersister data, hardened tests through maintainer feedback, and shipped the patch in TanStack Query v5.85.9.'
date: '2025-09-02'
