...
const AnimatedSection = dynamic(
  () => import('@/components/about/animated-section'),
);
    ...
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <AnimatedSection>
        <article className="prose dark:prose-invert max-w-none text-sm leading-relaxed">
          <p>
            <strong>2022년 초</strong>, 처음으로 개발 공부를 시작했습니다. 같은
            해 여름부터는 웹 개발, 그중에서도 <strong>프론트엔드</strong>에
            집중했습니다.
          </p>
          <p>
            개발에 발을 들인 계기는 단순했습니다. 전공인 공공정책학과 수업이
            너무 재미없었고, “그냥 놀기에는 아까우니 재미있어 보이는 것이라도 해
            보자”는 마음으로 유튜브 <strong>C/C++</strong> 강의를 들으며 코드를
            따라 쳤습니다.
          </p>
          <p>
            강의를 따라 코드를 작성하고 실행해 결과물을 확인하는 과정은 무척
            흥미로웠습니다. 그러나 이내 “코드 작성 → 결과 확인”보다 “코드를
            어떻게 작성해야 하는가”에 초점이 맞춰지면서 재미가 급격히
            떨어졌습니다. 지금은 그 중요성을 잘 이해하지만 당시에는 흥미를
            잃었죠.
          </p>
          <p>
            그래서 시선을 <strong>웹 개발</strong>, 특히 프론트엔드로
            돌렸습니다. 프론트엔드는 “코드 작성 → 시각적 결과 확인”이 필수라
            학습 단계에서도 즉각적인 피드백이 있었습니다. 이 부분에 강한 매력을
            느껴 “이 일을 직업으로 삼자”고 결심했습니다.
          </p>
          <p>
            문제는 <strong>습관</strong>이었습니다. 공부법을 몰랐던 저는
            서울대에 다니는 친구에게 조언을 구했습니다. 친구는 “공부를 하든, 멍
            때리든, 잠을 자든 상관없이 매일 아침 2시간 카페나 독서실에 앉아
            있어라”라고 했습니다. 당시에는 이해하지 못했지만, 지금 돌이켜 보면
            “습관을 먼저 만들어라”는 의미였죠.
          </p>
          <p>
          ...
          <p>
            당시 코박에는 프론트엔드 개발자가 저 혼자라 “React 16을 18로
            올릴까?”, “Next.js로 갈까?”, “상태 관리는 무엇을 쓸까?” 같은 결정을
            모두 스스로 내려야 했습니다. 가장 중요한 원칙은 “다음 개발자가
            별다른 히스토리 파악 없이 바로 업무를 이어받을 수 있어야
            한다”였습니다. 그래서 커뮤니티가 크고 문서가 잘 갖춰진{' '}
            <strong>대중적인 스택</strong>을 선택했습니다.
          </p>
          <p>
          ...
          <p>
            ...
            구글 시트를 연동해 QA·기획팀 작업 기간을 <strong>7일 → 3일</strong>
            로 단축했습니다.
          </p>
          <p>
